    ...
    fun filterChain(http: HttpSecurity): SecurityFilterChain {
        ...
        http.authorizeHttpRequests { ar ->
            ar
                ...
                .requestMatchers(mvc.pattern("/api/v1/model/deleteByWeaponType")).hasAuthority("ADMIN")
                .requestMatchers(mvc.pattern("/api/v1/model/deleteWoToothpick")).hasAuthority("ADMIN")
                .requestMatchers(mvc.pattern("/api/v1/model/makeThemAllSad")).hasAuthority("ADMIN")
